...
public class MyListener extends RLA{
	private static final Logger L = Logger.getLogger(MyListener.class);
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
       ...
       return new PrintWriter(new BufferedWriter(new FileWriter(new File(
               outdir, "emailable-dated-report1"
    ...
    protected void generateExceptionReport(Throwable exception,
       ...
       // m_out.print(Utils.stackTrace(exception, true)[0]);
        m_out.print(exception.getMessage());
        m_out.println("</div>");
    }
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println("<head>");
        out.println("<title>Mohammed A Zahid - TestNG Report</title>");
    ...
    protected void endHtml(PrintWriter out) {
        out.println("<center> Report customized by Mohammed A Zahid [abdulzahid.01@gmail.com] </center>");
